...
- A bare backlight write can sit accepted but visibly unapplied on the panel for a long time; see [ARCHITECTURE.md](ARCHITECTURE.md#the-confirmatory-read) for why every write is followed by a brief read.
