...
- On a Samsung QN90B, the physical picture takes roughly 10 seconds to start responding to a backlight change and another 10-15 seconds to finish fading to the new level. Dragging the slider and immediately checking the screen looks like it barely worked; give it 20-25 seconds. This is the panel's own ramp, not a delay in Home Assistant or HomeKit.
